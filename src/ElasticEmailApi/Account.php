...
class Account extends \ElasticEmailClient\ElasticRequest
{
     ...
     * @return string
     */
    public function AddSubAccount($email, $password, $confirmPassword, $poolName = null, $allow2fa = false, $requiresEmailCredits = false, $maxContacts = 0, $enablePrivateIPRequest = true, $sendActivation = false, $returnUrl = null, $sendingPermission = null, $enableContactFeatures = null, $emailSizeLimit = 10, $dailySendLimit = null) {
     ...
     * @param string $poolName Name of your custom IP Pool to be used in the sending process
     */
    public function UpdateSubAccountSettings($publicAccountID = null, $poolName = null, $requiresEmailCredits = false, $allow2fa = null, $monthlyRefillCredits = 0, $dailySendLimit = null, $emailSizeLimit = 10, $enablePrivateIPRequest = false, $maxContacts = 0, $subAccountEmail = null, $sendingPermission = null, $enableContactFeatures = null) {
